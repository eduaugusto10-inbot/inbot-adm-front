                ...
                <div ref={props.modalRef} className="modal-overlay" onClick={clickOutModal}>
                    <div onClick={(e) => e.stopPropagation()} className="modal-box">
                        ...
                        <div className="column-align">
                            <span></span>
                            <span style={{ color:"#0d5388", fontWeight:"bold" }}>{props.buttonB === "OK" ? "Padrão é: 5512345678901":props.buttonB!=="NaoExibir" ? "Essa ação não poderá ser desfeita." : "Clique em fechar para continuar"}</span>
