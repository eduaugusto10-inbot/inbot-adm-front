                ...
                <table className="table-2024 fixed-header-table" style={{ minWidth: "90%",flexShrink: "0" }} ref={tableRef}>
                    <thead>
                        <tr className="cells table-2024 border-bottom-zero font-size-12">
                            ...
                            <th className="cells">ID de usuário</th>
                    ...
                    {filteredCustomers.map((customer, index) => (
                        <tr key={index} style={{backgroundColor:  index % 2 === 0 ? '#ecebeb' : 'white'}}>
                            ...
                            <td><span className="font-size-12"><a href={`https://in.bot/inbot-admin?action=view_log2&bot_id=${botId}&user_id=${customer.phone}&date=${customer.data_disparo}`} target="_blank">{customer.phone}_</a></span></td>
